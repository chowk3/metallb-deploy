pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/chowk3/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('chowk3-225')   // <---- Change this to match your kubernetes cluster credentials
    }
